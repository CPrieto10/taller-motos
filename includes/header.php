        ...
        <ul>
            <?php if (isset($_SESSION['usuario_id'])): ?>
                ...
                <?php if (isset($_SESSION['usuario_rol']) && $_SESSION['usuario_rol'] === 'admin'): ?>
                    <li><a href="/proyectomotos/views/admin_usuarios.php">Usuarios</a></li>
                <?php endif; ?>
            <?php else: ?>
                <li><a href="/proyectomotos/index.php">Inicio</a></li>
                <li><a href="/proyectomotos/views/login.php">Iniciar sesión</a></li>
                <li><a href="/proyectomotos/views/registro.php">Registrarse</a></li>
            <?php endif; ?>
        </ul>
    </nav>
</header>
